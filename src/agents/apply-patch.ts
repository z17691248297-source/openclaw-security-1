...
import { enforceTrustedScopeForPatch } from "../security/trusted-isolation/scope.js";
...
export function createApplyPatchTool(
  ...
  return {
    ...
    label: "apply_patch",
    description:
      "Apply a patch to one or more files using the apply_patch format, including deleting files with *** Delete File. The input should include *** Begin Patch and *** End Patch markers.",
...
async function resolvePatchPath(
  ...
  if (options.sandbox) {
    ...
    enforceTrustedScopeForPatch({
      args: options.trustedArgs,
      absolutePath: resolved.hostPath ?? resolved.containerPath,
