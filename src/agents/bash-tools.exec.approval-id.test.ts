...
function expectPendingApprovalText(
  ...
  expect(pendingText).toContain("Reply with: allow-once|allow-always|deny");
  expect(pendingText).toContain(`If needed, use: /approve ${details.approvalSlug} allow-once`);
