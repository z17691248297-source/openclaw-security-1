...
const TrustedIsolationVerifySchema = z
  .object({
    mode: z.union([z.literal("none"), z.literal("hmac-sha256"), z.literal("ed25519")]).optional(),
    hmacKey: z.string().optional(),
    publicKeyPem: z.string().optional(),
    requireScopeToken: z.boolean().optional(),
  })
  .strict()
  .optional();

const TrustedIsolationSchema = z
  .object({
    enabled: z.boolean().optional(),
    enforceFailClosed: z.boolean().optional(),
    backendBaseUrl: z.string().optional(),
    authorizePath: z.string().optional(),
    completePath: z.string().optional(),
    requestTimeoutMs: z.number().int().positive().optional(),
    ttlMs: z.number().int().positive().optional(),
    verify: TrustedIsolationVerifySchema,
    riskThresholds: z
      .object({
    ...
    contextScores: z
      .object({
        outsideWorkspace: z.number().optional(),
        untrustedSource: z.number().optional(),
        noUserConfirmation: z.number().optional(),
      })
      .strict()
      .optional(),
    effectScores: z
      .object({
        ...
        exfiltration: z.number().optional(),
        privilegeEscalation: z.number().optional(),
      })
      .strict()
      .optional(),
    levelToDecision: z
    ...
    forceTrustedActions: z
      ...
      .optional(),
    forceTrustedTools: z.array(z.string()).optional(),
    protectedPathPrefixes: z.array(z.string()).optional(),
    denyObjectPrefixes: z.array(z.string()).optional(),
...
export const AgentToolsSchema = z
  .object({
    ...
    fs: ToolFsSchema,
    trustedIsolation: TrustedIsolationSchema,
