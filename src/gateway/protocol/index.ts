...
import {
  ...
  type ExecApprovalResolveRouteParams,
  ExecApprovalResolveRouteParamsSchema,
...
export const validateExecApprovalResolveRouteParams = ajv.compile<ExecApprovalResolveRouteParams>(
  ExecApprovalResolveRouteParamsSchema,
);
